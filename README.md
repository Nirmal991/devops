...
The system provisions either **local Docker-based environments** or **cloud instances (such as AWS or similar platforms)** using script-driven automation. It also supports automated installation and configuration of core dependencies such as **Terraform or Ansible**.

By defining infrastructure in code, the system ensures **consistent deployment across development, testing, and production environments**.
...
- 🔹 Infrastructure is **validated** to ensure successful setup
...
### 🔹 CI/CD Integration
Deployment pipelines automatically **provision infrastructure when code changes are pushed**.
...
Infrastructure can **scale horizontally** as telecom demand increases.
...
- **MOHD DILSHAD KHAN** (EN22CS301602)  
- **PARIDHI GUPTA** (EN22CS301683)  
- **NISHIT SHARMA** (EN22CS301658)  
- **MOHD SUHAIL KHAN** (EN22CS301604)  
- **NIRMAL KANT SHRIVASTAVA** (EN22CS301656)  
